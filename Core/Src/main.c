...
int main(void)
{
  ...
  while (1)
  {
    ...
    if((currentMs - timePrevRefreshMs) >= 1000) { // Every second, change the digits
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, D0_Pin|A4_Pin|D1_Pin|A5_Pin
                          |D2_Pin|A6_Pin|LED_Pin|D5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, D3_Pin|A2_Pin|D9_Pin|D8_Pin
  ...
  GPIO_InitStruct.Pin = D0_Pin|A4_Pin|D1_Pin|A5_Pin
                          |D2_Pin|A6_Pin|LED_Pin|D5_Pin;
  ...
  /*Configure GPIO pins : D3_Pin A2_Pin D9_Pin D8_Pin
                           D7_Pin D6_Pin D4_Pin A1_Pin
                           A3_Pin */
  GPIO_InitStruct.Pin = D3_Pin|A2_Pin|D9_Pin|D8_Pin
                          |D7_Pin|D6_Pin|D4_Pin|A1_Pin
                          |A3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
